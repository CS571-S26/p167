...
The project utilizes NewsData.io as the API to get this data. The project also utilizes a Supabase Edge Function to securely store an API key and make the necessary NewsData API call.
